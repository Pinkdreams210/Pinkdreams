...
<a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/custom-field-manager" class="xyz_star">Rate this plugin</a> -
...
<input type="hidden" name="redirActive" value="http://xyzscripts.com/subscription/pending/XYZWPCFL">
<input type="hidden" name="redirPending" value="http://xyzscripts.com/subscription/active/XYZWPCFL">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class="submit_cfl_new" type="submit" value="Subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />

<input type="hidden" name="listName" value="8,1,"/>
</form>
</div>   
<p></p>

<div style="padding-top: 10px;" class="xyz_plugins">
Our Plugins : 
