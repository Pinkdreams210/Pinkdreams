...
class RepUPress_Customize_Woocommerce_Scripts
{
    ...
    {
        wp_register_style(
            'woo-product-customizer-admin-styles',
            REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/css/style-admin.css',
            array(),
            null
        );
        ...
        wp_enqueue_style(
            'jquery-style',
            REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/css/jquery-ui.css',
            array(),
            null
        );
    }
    ...
    public function repupress_customize_woocommerce_product_admin_scripts( $hook_suffix )
    {
        ...
        if ( in_array( $hook_suffix, array( 'woocommerce_page_woo-product-customizerort' ) ) ) {
            ...
            wp_register_script(
                'woo-product-customizer-admin-scripts',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/js/woo-product-customizer-admin.js',
                array( 'jquery', 'jquery-ui-sortable' ),
                null,
                true
            );
            wp_enqueue_script( 'woo-product-customizer-admin-scripts' );
            wp_localize_script( 'woo-product-customizer-admin-scripts', 'WooOrderExp', array(
                'new_media_ui' => $newui,
            ) );
            wp_enqueue_media();
            ...
            wp_register_script(
                'woo-order-choosen',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/js/woo-product-customizer-chosen.jquery.js',
                array( 'jquery' ),
                null,
                true
            );
            ...
            wp_register_style(
                'woo-order-choosen-css',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/css/woo-product-customizer-chosen.css',
                array(),
                null
            );
    ...
    {
        wp_register_style(
            'woo-product-customizer-public-style',
            REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/css/woo-product-customizer-public-style.css',
            array(),
            null
        );
    ...
    public function repupress_customize_woocommerce_product_public_scripts()
    {
        ...
        if ( is_shop() ) {
            ...
            wp_register_script(
                'woo-product-customizer-front-scripts',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/js/woo-product-customizer-front-shop.js',
                array( 'jquery', 'jquery-ui-sortable' ),
                null,
                true
            );
        ...
        if ( is_product() ) {
            ...
            wp_register_script(
                'woo-product-detail-customizer-front-scripts',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/js/woo-product-customizer-front-detail.js',
                array( 'jquery', 'jquery-ui-sortable' ),
                null,
                true
            );
        ...
        if ( is_checkout() ) {
            ...
            wp_register_script(
                'woo-product-detail-customizer-front-scripts',
                REPUPRESS_CUSTOMIZE_WOOCOMMERCE . 'includes/js/woo-product-customizer-front-checkout.js',
                array( 'jquery', 'jquery-ui-sortable' ),
                null,
                true
            );
