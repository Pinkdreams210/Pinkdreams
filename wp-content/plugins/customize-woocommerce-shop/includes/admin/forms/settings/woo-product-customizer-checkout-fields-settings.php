...
if ( isset( $_POST['repupress_customize_woocommerce_product_save_settings'] ) && !empty($_POST['repupress_customize_woocommerce_product_save_settings']) && $_POST['repupress_customize_woocommerce_product_save_settings'] == __( 'Save Settings', 'repupresscustomwoocommerceproduct' ) ) {
    //check click of save button
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_fields_show_order_details'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_details', filter_var( $_POST['repupress_customize_woocommerce_product_fields_show_order_details'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_details', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_fields_show_order_email'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_email', filter_var( $_POST['repupress_customize_woocommerce_product_fields_show_order_email'], FILTER_FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_email', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_fields_show_order_edit'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_edit', filter_var( $_POST['repupress_customize_woocommerce_product_fields_show_order_edit'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_fields_show_order_edit', 0 );
    }
