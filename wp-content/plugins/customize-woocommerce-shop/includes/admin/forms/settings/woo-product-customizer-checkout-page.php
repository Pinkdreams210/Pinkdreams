...
if ( isset( $_POST['repupress_customize_woocommerce_product_settings_save'] ) && !empty($_POST['repupress_customize_woocommerce_product_settings_save']) && $_POST['repupress_customize_woocommerce_product_settings_save'] == __( 'Save All Settings', 'repupresscustomwoocommerceproduct' ) ) {
    ...
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_country'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_country', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_country'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_country', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_first_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_first_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_first_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_first_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_last_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_last_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_last_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_last_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_company'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_company', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_company'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_company', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_address_1'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_address_1', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_address_1'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_address_1', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_address_2'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_address_2', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_address_2'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_address_2', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_city'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_city', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_city'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_city', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_state'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_state', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_state'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_state', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_postcode'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_postcode', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_postcode'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_postcode', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_email'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_email', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_email'], FILTER_VALIDATE_EMAIL ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_email', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_billing_phone'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_phone', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_billing_phone'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_billing_phone', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_country'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_country', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_country'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_country', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_first_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_first_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_first_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_first_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_last_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_last_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_last_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_last_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_company'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_company', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_company'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_company', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_address_1'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_address_1', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_address_1'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_address_1', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_address_2'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_address_2', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_address_2'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_address_2', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_city'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_city', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_city'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_city', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_state'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_state', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_state'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_state', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_shipping_postcode'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_postcode', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_shipping_postcode'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_shipping_postcode', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_account_password'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_account_password', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_account_password'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_account_password', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_order_comments'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_order_comments', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_order_comments'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_order_comments', 0 );
    }
    
    //Optional
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_country'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_country', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_country'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_country', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_first_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_first_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_first_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_first_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_last_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_last_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_last_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_last_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_company'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_company', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_company'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_company', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_address_1'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_address_1', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_address_1'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_address_1', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_address_2'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_address_2', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_address_2'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_address_2', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_city'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_city', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_city'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_city', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_state'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_state', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_state'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_state', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_postcode'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_postcode', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_postcode'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_postcode', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_email'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_email', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_email'], FILTER_VALIDATE_EMAIL ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_email', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_phone'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_phone', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_billing_phone'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_billing_phone', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_country'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_country', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_country'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_country', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_first_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_first_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_first_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_first_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_last_name'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_last_name', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_last_name'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_last_name', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_company'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_company', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_company'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_company', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_address_1'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_address_1', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_address_1'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_address_1', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_address_2'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_address_2', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_address_2'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_address_2', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_city'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_city', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_city'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_city', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_state'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_state', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_state'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_state', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_postcode'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_postcode', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_shipping_postcode'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_shipping_postcode', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_account_password'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_account_password', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_account_password'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_account_password', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_opt_order_comments'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_order_comments', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_opt_order_comments'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_opt_order_comments', 0 );
    }
    
    //Appearance
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_title_font_color'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_color', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_title_font_color'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_color', '#000000' );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_title_font_size'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_size', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_title_font_size'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_size', '' );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_checkout_title_font_weight'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_weight', filter_var( $_POST['repupress_customize_woocommerce_product_checkout_title_font_weight'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_checkout_title_font_weight', '' );
    }
