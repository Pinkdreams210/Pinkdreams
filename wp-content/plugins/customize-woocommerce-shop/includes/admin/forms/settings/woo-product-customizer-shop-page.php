...
if ( isset( $_POST['repupress_customize_woocommerce_product_settings_save'] ) && !empty($_POST['repupress_customize_woocommerce_product_settings_save']) && $_POST['repupress_customize_woocommerce_product_settings_save'] == __( 'Save All Settings', 'repupresscustomwoocommerceproduct' ) ) {
    ...
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_list'] ) ) {
        ...
        update_option( 'repupress_customize_woocommerce_product_shop_product_list', 'all' );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_image'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_shop_product_image', filter_var( $_POST['repupress_customize_woocommerce_product_shop_product_image'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_shop_product_image', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_title'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_shop_product_title', filter_var( $_POST['repupress_customize_woocommerce_product_shop_product_title'], FILTER_SANITIZE_STRING ) );
    } else {
    ...
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_prices'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_shop_product_prices', filter_var( $_POST['repupress_customize_woocommerce_product_shop_product_prices'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_shop_product_prices', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_add_to_cart'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_shop_product_add_to_cart', filter_var( $_POST['repupress_customize_woocommerce_product_shop_product_add_to_cart'], FILTER_SANITIZE_STRING ) );
    } else {
        update_option( 'repupress_customize_woocommerce_product_shop_product_add_to_cart', 0 );
    }
    
    
    if ( isset( $_POST['repupress_customize_woocommerce_product_shop_product_logged_in'] ) ) {
        update_option( 'repupress_customize_woocommerce_product_shop_product_logged_in', filter_var( $_POST['repupress_customize_woocommerce_product_shop_product_logged_in'], FILTER_SANITIZE_STRING ) );
    } else {
