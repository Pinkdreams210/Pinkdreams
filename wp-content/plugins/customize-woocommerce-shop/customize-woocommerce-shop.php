...
if ( !defined( 'REPUPRESS_CUSTOMIZE_WOOCOMMERCE' ) ) {
    define( 'REPUPRESS_CUSTOMIZE_WOOCOMMERCE', plugin_dir_url( __FILE__ ) );
}
if ( !defined( 'WOO_PRODUCT_CUST_DIR' ) ) {
    define( 'WOO_PRODUCT_CUST_DIR', dirname( __FILE__ ) );
}
if ( !defined( 'WOO_PRODUCT_CUST_ADMIN' ) ) {
    define( 'WOO_PRODUCT_CUST_ADMIN', WOO_PRODUCT_CUST_DIR . '/includes/admin' );
}
